...
## Опис
Каталог товарів для інтернет-магазину з різними підходами до стилізації. Проєкт демонструє використання CSS Modules, Tailwind CSS (або іншого utility-first підходу), Material-UI та традиційного CSS/SCSS в різних частинах додатку.
